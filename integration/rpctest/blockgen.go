...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr twhutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*twhutil.Tx, error) {
...
func CreateBlock(prevBlock *twhutil.Block, inclusionTxs []*twhutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr twhutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*twhutil.Block, error) {
	...
	blockTxns := []*twhutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := twhutil.NewBlock(&block)
