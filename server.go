...
import (
	...
	"github.com/nicholas-mwaura/twhd/addrmgr"
	...
	"github.com/nicholas-mwaura/twhd/connmgr"
	"github.com/nicholas-mwaura/twhd/database"
	"github.com/nicholas-mwaura/twhd/mempool"
	"github.com/nicholas-mwaura/twhd/mining"
	"github.com/nicholas-mwaura/twhd/mining/cpuminer"
	"github.com/nicholas-mwaura/twhd/netsync"
	...
	"github.com/nicholas-mwaura/twhutil/bloom"
)
...
func (sp *serverPeer) OnTx(_ *peer.Peer, msg *wire.MsgTx) {
	...
	// Convert the raw MsgTx to a twhutil.Tx which provides some convenience
	// methods and things such as hash caching.
	tx := twhutil.NewTx(msg)
...
func (sp *serverPeer) OnBlock(_ *peer.Peer, msg *wire.MsgBlock, buf []byte) {
	// Convert the raw MsgBlock to a twhutil.Block which provides some
	// convenience methods and things such as hash caching.
	block := twhutil.NewBlockFromBlockAndBytes(msg, buf)
...
func (sp *serverPeer) OnFeeFilter(_ *peer.Peer, msg *wire.MsgFeeFilter) {
	...
	if msg.MinFee < 0 || msg.MinFee > twhutil.MaxSatoshi {
		peerLog.Debugf("Peer %v sent an invalid feefilter '%v' -- "+
			"disconnecting", sp, twhutil.Amount(msg.MinFee))
		sp.Disconnect()
		return
	}
...
func (s *server) TransactionConfirmed(tx *twhutil.Tx) {
...
func newServer(listenAddrs, agentBlacklist, agentWhitelist []string,
	...
	txC := mempool.Config{
		...
		CalcSequenceLock: func(tx *twhutil.Tx, view *blockchain.UtxoViewpoint) (*blockchain.SequenceLock, error) {
