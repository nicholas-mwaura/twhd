...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*twhutil.Block, error) {
	...
	blocks := make([]*twhutil.Block, 0, 256)
	genesis := twhutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
