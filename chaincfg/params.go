...
var MainNetParams = Params{
	...
	DefaultPort: "8372",
	DNSSeeds: []DNSSeed{
		{"seed.radi.network",true);  // radi network
		{"seed.raditech.online",true);  // radi network
	...
	RuleChangeActivationThreshold: 1915, // 95% of MinerConfirmationWindow
	...
	Deployments: [DefinedDeployments]ConsensusDeployment{
		...
		DeploymentCSV: {
			BitNumber:  0,
			StartTime:  1556668800, // May 1st, 2019
			ExpireTime: 1588291200, // May 1st, 2020
		},
		DeploymentSegwit: {
			BitNumber:  1,
			StartTime:  1556668800, // May 1st, 2019 
	...
	// BIP 173.
	Bech32HRPSegwit: "wv", // always wv for main net

	// Address encoding magics
	PubKeyHashAddrID:        0x49, // starts with 1
	ScriptHashAddrID:        0x0A, // starts with 3
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "rwv", // always bcrt for reg test net

	// Address encoding magics
	PubKeyHashAddrID: 0x70, // starts with m or n
	ScriptHashAddrID: 0xc5, // starts with 2
	PrivateKeyID:     0xf0, // starts with 9 (uncompressed) or c (compressed)
...
var TestNet3Params = Params{
	...
	Deployments: [DefinedDeployments]ConsensusDeployment{
		...
		DeploymentSegwit: {
			BitNumber:  1,
			StartTime:  1556668800, // May 1, 2019 UTC
			ExpireTime: 1588291200, // May 1, 2020 UTC.
		},
	},
	...
	// Address encoding magics
	PubKeyHashAddrID:        0x87, // starts with m or n
...
func CustomSignetParams(challenge []byte, dnsSeeds []DNSSeed) Params {
	...
	return Params{
		...
		// Human-readable part for Bech32 encoded segwit addresses, as defined in
		// BIP 173.
		Bech32HRPSegwit: "tw", // always tb for test net
