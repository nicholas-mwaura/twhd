...
import (
	...
	peerpkg "github.com/nicholas-mwaura/twhd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*twhutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *twhutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *twhutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *twhutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
