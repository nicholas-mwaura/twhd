...
import (
	...
	"github.com/nicholas-mwaura/twhutil/gcs"
	"github.com/nicholas-mwaura/twhutil/gcs/builder"
)
...
func storeFilter(dbTx database.Tx, block *twhutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *twhutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *twhutil.Block,
