...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *twhutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *twhutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) ConnectBlock(dbTx database.Tx, block *twhutil.Block,
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *twhutil.Block,
	stxo []blockchain.SpentTxOut) error {
