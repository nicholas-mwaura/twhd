...
func GetBlockWeight(blk *twhutil.Block) int64 {
...
func GetTransactionWeight(tx *twhutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *twhutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
