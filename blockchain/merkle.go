...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*twhutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *twhutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *twhutil.Block) error {
