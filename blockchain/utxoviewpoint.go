...
func (view *UtxoViewpoint) AddTxOut(tx *twhutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *twhutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *twhutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *twhutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *twhutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *twhutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *twhutil.Tx) (*UtxoViewpoint, error) {
