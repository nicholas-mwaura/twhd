...
const (
	...
	defaultMaxFeeRate = twhutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*twhutil.Tx, error) {
	...
	return twhutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*twhutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[twhutil.Address]twhutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[twhutil.Address]twhutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address twhutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address twhutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address twhutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address twhutil.Address, skip,
