...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []twhutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []twhutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee twhutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee twhutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address twhutil.Address, amount twhutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address twhutil.Address, amount twhutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address twhutil.Address,
	amount twhutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address twhutil.Address, amount twhutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress twhutil.Address, amount twhutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress twhutil.Address, amount twhutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress twhutil.Address, amount twhutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress twhutil.Address, amount twhutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress twhutil.Address, amount twhutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress twhutil.Address,
	amount twhutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[twhutil.Address]twhutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[twhutil.Address]twhutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[twhutil.Address]twhutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[twhutil.Address]twhutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (twhutil.Address, error) {
	...
	return twhutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []twhutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []twhutil.Address, account string) (twhutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []twhutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []twhutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (twhutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (twhutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (twhutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (twhutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (twhutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (twhutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (twhutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (twhutil.Address, error) {
...
func (c *Client) GetAccountAsync(address twhutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address twhutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address twhutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address twhutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]twhutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]twhutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = twhutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]twhutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount twhutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount twhutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount twhutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount twhutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount twhutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount twhutil.Amount,
...
func (c *Client) ValidateAddressAsync(address twhutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address twhutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]twhutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]twhutil.Amount)
	for k, v := range accounts {
		amount, err := twhutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]twhutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]twhutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (twhutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := twhutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the Response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (twhutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (twhutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (twhutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (twhutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (twhutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (twhutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (twhutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (twhutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (twhutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address twhutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address twhutil.Address) (twhutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address twhutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address twhutil.Address, minConfirms int) (twhutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address twhutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address twhutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address twhutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address twhutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*twhutil.WIF, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return twhutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address twhutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address twhutil.Address) (*twhutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *twhutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *twhutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *twhutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *twhutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *twhutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *twhutil.WIF, label string, rescan bool) error {
